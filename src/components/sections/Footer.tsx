        ...
        <footer className="bg-gray-900 text-white py-12 px-6">
            <div className="max-w-4xl mx-auto text-center">
                <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 shrink-0">
                    <Image src="/logo-transparent.webp" alt="Crveni križ Buje" width={128} height={128} />
                </div>
                <h3 className="text-2xl font-bold mb-4">Hrvatski Crveni Križ - Gradsko društvo Crvenog križa Buje</h3>
