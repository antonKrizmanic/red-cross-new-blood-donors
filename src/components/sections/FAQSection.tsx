...
const faqData: FAQItem[] = [
	...
	},
	{
		...
		answer:
			"Krv može darivati svaka osoba: dobrog općeg zdravstvenog stanja, u dobi od 18 do 65 godina, tjelesne težine iznad 55 kilograma, koja zadovoljava kriterije za odabir darivatelja krvi.",
	},
	{
		id: 3,
		question: "Kada darivati krvi?",
		answer:
			"Stanje zaliha doza krvi Vaše krvne grupe možete saznati na stranici Hrvatskog zavoda za transfuzijski medicinu. Ako su trenutačne zalihe krvi Vaše krvne grupe ispod oznake premale zalihe, molimo Vas darujte krv. Ako su trenutačne količine krvi Vaše krvne grupe iznad oznake prevelike zalihe, molimo Vas privremeno odgodite darivanje dok se zalihe Vaše krvne grupe ne smanje. Muškarci mogu darivati krv svaka 3 mjeseca (do 7 dana ranije), a žene svaka 4 mjeseca (do 7 dana ranije). Podatak o datumu prethodnog darivanja nalazi se u Vašoj Iskaznici darivatelja. Ako nemate Iskaznicu darivatelja taj podatak možete dobiti na broj telefona 01/4600-337.",
	},
	{
		id: 4,
		question: "Što se preopruča prije darivanja krvi?",
		answer:
			"Pojedite lagani obrok i uzmite dovoljno bezalkoholne tekućine. Pripremite osobnu iskaznicu ili putovnicu i zdravstvenu iskaznicu. Ponesite i Iskaznicu darivatelja krvi, kako bi Vam mogli upisati darivanje.",
	},
	{
		id: 5,
		question: 'Mora li se prije darivanja biti "na tašte"?',
		answer:
			"Prije davanja krvi nije potrebno biti natašte. Davanje krvi je sastavni dio svakodnevnog ljudskog načina života i čovjek na taj dan treba uobičajeno jesti i piti. Osjećati ćete se bolje ako nekoliko sati prije davanja krvi pojedete lagani obrok. Jedino Vas molimo da unutar 8 sati prije davanja krvi ne jedete izrazito masnu hranu i ne pijete alkohol jer njihovi sastojci mogu transfuzijom krvi biti uneseni u bolesnika i nanijeti mu štetu.",
	},
	{
		id: 6,
...
export function FAQSection() {
	...
	return (
		<section
			id="pitanja"
			className="py-20 px-6 bg-gradient-to-br from-red-50 via-white to-red-50"
		>
			<div className="max-w-4xl mx-auto">
				...
				<div className="text-center mb-16">
					...
					<p className="text-xl text-gray-600 max-w-2xl mx-auto">
						Pronađite odgovore na najčešća pitanja o darivanju krvi i pomozite
						nam spasiti živote
					</p>
				</div>
				...
				<div className="text-center mt-16">
					<div className="bg-gradient-to-r from-red-900/80 via-red-800/70 to-red-900/80 rounded-3xl p-8 md:p-12 text-white">
						...
						<p className="text-red-100 text-lg mb-8 max-w-2xl mx-auto">
							Naš tim je tu da vam pomogne. Kontaktirajte nas i dobit ćete
							odgovor u najkraćem mogućem roku.
						</p>
						<Button
							size="lg"
							onClick={() =>
