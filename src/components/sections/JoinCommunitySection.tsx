            ...
            <div className="relative z-10 container mx-auto">
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-white/90 max-w-3xl mx-auto">
                        Budi dio naše zajednice darivatelja krvi i primi
                        obavijesti o nadolazećim akcijama darivanja krvi.
                        Otvoreno je za sve - i za one koji već daruju i za one
                        koji se tek planiraju pridružiti.
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-red-100">
                                    Prvi saznajte termin i lokaciju sljedeće
                                    akcije darivanja u vašem gradu.
                                </p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-red-100">
                                    Obavijesti da ne propustite priliku za
                                    darivanje krvi.
                                </p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-red-100">
                                    U svakom trenutku možete prestati primati
                                    obavijesti — bez obveza.
                                </p>
                            </div>
                        </div>
                    </div>
