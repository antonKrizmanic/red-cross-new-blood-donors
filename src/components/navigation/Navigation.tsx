...
export function Navigation() {
    ...
    return (
        <nav
            className={`fixed top-1 left-0 right-0 z-50 transition-all duration-300 ${isVisible ? 'translate-y-0' : '-translate-y-full'
                } ${isScrolled
        ...
        >
            ...
            {/* Mobile Menu Overlay */}
            <div className={`md:hidden fixed inset-0 z-[9999] bg-white transition-all duration-300 ${isMobileMenuOpen
                ...
                <div className="absolute inset-0 bg-white min-h-screen">
                    ...
                    <div className="p-6 space-y-6 bg-white">
                        ...
                        <button
                            onClick={() => handleMobileNavClick('zasto-dariti-krv')}
                            className="w-full text-left text-2xl font-semibold text-gray-900 hover:text-red-800 transition-colors duration-200 py-4"
                        >
                            Zašto darivati
                        </button>
