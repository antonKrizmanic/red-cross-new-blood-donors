...
export function WhyDonateSection() {
    return (
        <section id="zasto-dariti-krv" className="py-20 px-6 bg-white relative overflow-hidden min-h-screen flex flex-col items-center justify-center">
            {/* Background image */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                    <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-0 shadow-lg">
                        <CardContent className="p-6 md:p-8 text-center">
                            ...
                            <p className="text-gray-600">Vaša donacija dovoljna je za 3 doze krvi</p>
                        </CardContent>
                    </Card>
