    ...
    const steps = [
        {
            ...
            title: 'Registracija',
            description:
                'Registracija, popunjavanje ankete i zdravstveni pregled',
            time: '10-15 min',
        },
        {
            icon: Droplets,
                    ...
                    <div className="space-y-8">
                        <div className="space-y-4">
                            ...
                            <p className="text-xl text-gray-600">
                                Proces donacije je jednostavan, siguran i traje
                                manje od sat vremena od početka do kraja.
                            </p>
                        </div>
                        ...
                        <div className="bg-blue-50 p-6 rounded-lg">
                            ...
                            <ul className="text-sm text-blue-800 space-y-1">
                                ...
                                <li>
                                    • Ponesite valjanu osobnu iskaznicu s
                                    fotografijom
                                </li>
                                <li>
                                    • Izbjegavajte alkohol 24 sata prije
                                    donacije
                                </li>
                            </ul>
                        </div>
